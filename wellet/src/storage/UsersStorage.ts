...
export let users: User[] = [
    ...
    new User("John Smith", "test@ua.pt", undefined, "https://images.unsplash.com/photo-1514415959856-84514e035ce5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80", UserStatus.INACTIVE)
]